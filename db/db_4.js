const connection_4 = require("../connection4"); //  connection 1

connection_4.schema.hasTable("products").then(function (exists) {
  if (!exists) {
    return connection_4.schema
      .createTable("Tabs", function (table) {
        ...
        table.timestamp("date").defaultTo(connection_4.fn.now());
        table.timestamp("modified").defaultTo(connection_4.fn.now());
      })
      ...
      .createTable("sales_reports_tikets", function (table) {
        ...
        table.timestamp("timestamp").defaultTo(connection_4.fn.now());
        table.timestamp("modified").defaultTo(connection_4.fn.now());
      })
