const connection_3 = require("../connection3"); //  connection 1

connection_3.schema.hasTable("products").then(function (exists) {
  if (!exists) {
    return connection_3.schema
      .createTable("Tabs", function (table) {
        ...
        table.timestamp("date").defaultTo(connection_3.fn.now());
        table.timestamp("modified").defaultTo(connection_3.fn.now());
      })
      ...
      .createTable("sales_reports_tikets", function (table) {
        ...
        table.timestamp("timestamp").defaultTo(connection_3.fn.now());
        table.timestamp("modified").defaultTo(connection_3.fn.now());
      })
